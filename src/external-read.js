...
export const EXTERNAL_MIN_MS = 3 * 60 * 1000;
 ...
 *   - elapsed < 3 minutes   -> null (discard, likely a mis-tap or a glance)
 *   - 3 minutes <= elapsed <= 60m -> a reading-session record with a duration
