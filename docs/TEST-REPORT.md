...
최초 작성일: 2026-08-27 · 최종 검토(재배포 전) 갱신: 2026-08-27
...
- 13/13 통과 (기존 7개 + 이번에 추가한 6개): URL 정규화·위험 프로토콜 차단·태그 정규화, Markdown 단일/다중 항목 내보내기 머리말·본문 개수 일치, 백업 JSON 검증(다른 앱 거부·스키마 1과 2 모두 허용·잘못된 형태 거부), Cove Journal 레코드 계약.
